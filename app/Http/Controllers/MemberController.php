...
{
    public function index() { return 'MemberController@index'; }
    public function create() { return 'MemberController@create'; }
    public function store(Request $request) { return 'MemberController@store'; }
